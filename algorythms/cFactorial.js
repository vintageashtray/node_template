...
export function cFactorialLoop(n){
    ...
    l.info(` 3: The factorial of ${n} is: ${factorial}`);
}

let factorial;
export function cFactorialRecursion(n){
    if (!isArgumentValid(n, 'number')){return}
    
    if (n === 0){return 1};
    
    factorial = n * cFactorialRecursion(n - 1)
    l.info(` 3: The factorial (recursion) of ${n} is: ${factorial}`);
    return factorial
